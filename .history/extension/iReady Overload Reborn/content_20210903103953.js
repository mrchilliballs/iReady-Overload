...
UI.innerHTML = `
https://raw.githubusercontent.com/toert/Isolated-Bootstrap/master/versions/4.1.0/iso_bootstrap4.1.0min.css
<div class="container">
<style>
.iready-img {
    height: 20px;
...
-->
<script src="${chrome.runtime.getURL("script.js")}"></script>
`;
