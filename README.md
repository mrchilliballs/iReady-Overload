...
This repository is a collection of hacks that ensure nobody has to suffer through iReady ever again. The current version has a [lesson and quiz skipper](lessonSkipper/) and a [minutes hack](minutesHack/). You can view older versions of hacks [here](olderVersions/).
